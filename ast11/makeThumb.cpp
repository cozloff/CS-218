...
// getImageFileNames(argc, argv, &originalImage, &thumbImage);

// cout<<"originalImage: "<<originalImage<<endl; 
// cout<<"thumbImage: "<<thumbImage<<endl;
	...
	if (getImageFileNames(argc, argv, &originalImage, &thumbImage)) {
		...
		cout<<"picWidth: "<<picWidth<<endl; 
		cout<<"picHeight: "<<picHeight<<endl;
